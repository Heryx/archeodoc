...
function usDeterministicFields(us: USData): { topLevel: ProposedTopLevelFields; schedaData: Record<string, string> } {
  ...
  const map: Record<string, unknown> = {
    ...
    densitaInorganici: us.densitaMaterialeInorganici,
    densitaOrganici: us.densitaMaterialeOrganici,
    ...
    statoConservazione: us.statoConservazioneValutazione,
    danneggiatoDa: us.statoConservazioneModificazioni,
    ...
    datazione: us.datazioneAssoluta,
    ...
    campionatureN: us.campionature,
    flottazioneTipo: us.flottazione,
    flottazioneSecchi: us.flottazioneSecchi,
    setacciaturaTipo: us.setacciatura,
    ...
    responsabileSabap: us.responsabileSABAPUMB,
